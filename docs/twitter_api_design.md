...
## 13. 旧実装の参照方法
- 旧来の tweepy ベース実装（`create_tweet.py`, `handlers.py`, `twitter_api_tweepy.py`）は と削除済み。
- 移行前後の挙動比較が必要な場合は Git 履歴から復元する。`57963d0a1802be367b02958c2e8732d1dfe2ec40` 時点でプロジェクトルートに存在。
